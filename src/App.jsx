...
import { 
  ...
  AlertCircle, Globe, ChevronRight, Copy, Check, Info
} from 'lucide-react';
...
export default function AshokaManasPlatform() {
  ...
  // Fetch Posts
  useEffect(() => {
    const q = query(collection(db, 'artifacts', appId, 'public', 'data', 'ashoka_posts_v35')); 
  ...
  const handleCreatePost = async () => {
    ...
    await addDoc(collection(db, 'artifacts', appId, 'public', 'data', 'ashoka_posts_v35'), {
  ...
  const handleComment = async () => {
    ...
    const ref = doc(db, 'artifacts', appId, 'public', 'data', 'ashoka_posts_v35', selectedPost.id);
  ...
  const handleLike = async (e, post) => {
    e.stopPropagation();
    const ref = doc(db, 'artifacts', appId, 'public', 'data', 'ashoka_posts_v35', post.id);
